...
class RoundedCornersTransformation(
    ...
    constructor(radius: Int, margin: Int, diameter: Int) : this(
        radius,
        margin,
        radius * 2,
        CornerType.ALL
    ...
    override fun equals(o: Any?): Boolean {
        return o is RoundedCornersTransformation && o.radius === radius
                && o.diameter === diameter && o.margin === margin && o.cornerType === cornerType
    }
